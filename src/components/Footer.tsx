    ...
    <footer className="footer">
      ...
      <div className="footer-sky-section">
        ...
        <div className="footer-card">
          ...
          {/* Right: Main Content (Nav, Socials, Brand & Legal) */}
          <div className="footer-main-content">
            ...
            <div className="footer-social-row">
              ...
              <a href="mailto:huuthang.cv0612@gmail.com" className="footer-email">
                huuthang.cv0612@gmail.com
              </a>
            </div>

            {/* Brand Logo & Legal Links Row */}
            <div className="footer-brand-row">
              <div className="footer-brand-logo">
                <img src={DeutschUpLogo} alt="DeutschUp" className="footer-logo-img" />
              </div>
